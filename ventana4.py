...
class ninja:
    sprite = None
    archivo = 'japonecita'
    imagen = './imagenes/japonecita/idle/1.png'
    size = VECTOR((46,81))
    coord = VECTOR((64,800))
    indice = 0
    movimientos = []
    ...
    ataque_cooldown = 60  # Tiempo de espera tras atacar
    atacando = False
    retirada = 0  # Tiempo de retirada en frames
    animacion_ataque_activa = False
    tiempo_animacion_ataque = 0
    duracion_animacion_ataque = 18 # 6 imagenes para atacar
...
def ventana4():
    ...
    enemigoAtaca(ninja, canibalito2)

    # Mostrar vida
    font = pygame.font.SysFont(None, 24)
    text = font.render(f"Vida: {canibalito2.vida}", True, (255, 255, 255))
